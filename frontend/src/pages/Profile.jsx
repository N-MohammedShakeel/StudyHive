...
import { User as UserIcon, Mail, Edit, Save, Trash2, Lock } from "lucide-react";
import {
  getUserProfile,
  updateProfile,
  addPassword,
...
const Profile = () => {
  ...
  const [user, setUser] = useState(null); // Start null, fetch from backend
  ...
  const handlePasswordSave = async () => {
    ...
    try {
      if (user.googleId && !user.hasPassword) {
        await addPassword(passwordData.newPassword);
